...
export default function() {
    const url = 'https://api.load01.prizepicks.com/aeropay/create_payment'; // replace with your actual endpoint
    ...
    // Check for a successful response, for example a 200 OK
    check(response, {
